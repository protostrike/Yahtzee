...
public class ScoreCard {
    ...
    public void score(int[] dices, int category){
        ...
        if(category<=5)
            ...
            scoreYahtzee(dices);
            return; //Skipping the check yahtzee bonus part
        }
        else if(category==12)
            scoreChance(dices);
    ...
    public String toString() {
        ...
        if(lowerSection[1]==-1)
            thirdLine.append("| (8) Four of a Kind: ");
        else
            thirdLine.append("| (8) Four of a Kind: ").append(lowerSection[1]);
